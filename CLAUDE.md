...
- **Próximos passos:** (1) abrir PR de `feat/argocd-bootstrap` para `main`; (2) após o merge, iniciar a Fase 4 (CloudFront + Route 53 + external-dns + cert-manager com o domínio próprio).
