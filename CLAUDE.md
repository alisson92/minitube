...
- **Fase atual:** 3 — GitOps (Fase 2 encerrada por completo)
...
- **Próximos passos:** (1) abrir PR de `feat/phase-2-app` para `main`; (2) após o merge, iniciar a Fase 3 (ArgoCD + sincronização de `gitops/app/`, eliminando o `kubectl apply -k` manual desta fase).
