...
- **Próximos passos:** próximo entregável da Fase 1 — EKS com node group spot em `terraform/envs/lab/`, reaproveitando os outputs da VPC (`vpc_id`, `private_subnet_ids`, etc.) e seguindo o mesmo padrão de validação funcional pós-apply (seção 11 de `docs/engineering-standards.md`).
